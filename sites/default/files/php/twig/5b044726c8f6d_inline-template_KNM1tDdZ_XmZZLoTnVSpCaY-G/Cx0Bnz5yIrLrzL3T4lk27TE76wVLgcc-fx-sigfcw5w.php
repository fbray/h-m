...
/* {# inline_template_start #}<ul class="icons-list">
{{ field_mt_twitter_account }}
{{ field_mt_facebook_account }}
{{ field_mt_linkedin_account }}
</ul> */
class __TwigTemplate_12881d6e45c0067954c45b21dd03e1c08f420a4bd3bb5c53a324a9d9394320bf extends Twig_Template
{
...
";
    ...
    {
        return "{# inline_template_start #}<ul class=\"icons-list\">
{{ field_mt_twitter_account }}
{{ field_mt_facebook_account }}
{{ field_mt_linkedin_account }}
</ul>";
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}<ul class=\"icons-list\">
{{ field_mt_twitter_account }}
{{ field_mt_facebook_account }}
{{ field_mt_linkedin_account }}
</ul>", "");
