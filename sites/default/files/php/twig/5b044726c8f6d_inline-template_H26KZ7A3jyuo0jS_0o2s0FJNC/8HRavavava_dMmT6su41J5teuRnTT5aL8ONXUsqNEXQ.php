...
<a class="overlay-icon overlay-icon--button overlay-icon--white overlay-animated overlay-fade-top" href="{{ path }}"><i class="fa fa-external-link"></i></a>
</span>
</span>
{{ field_mt_member_photo }}
</div>
</div> */
class __TwigTemplate_d884ddf0c86499d17380a5d3ab3eba4fafad27c2f3ed2e8e58a1751ccacd90cb extends Twig_Template
{
