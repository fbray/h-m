...
/* {# inline_template_start #}{{ created }} <span class="comments-count">{{ comment_count }}</span> */
class __TwigTemplate_e40d1171ad13bec4e27303481886f7f6d95412203e07c8966c0f9691b90b1be5 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}{{ created }} <span class=\"comments-count\">{{ comment_count }}</span>";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}{{ created }} <span class=\"comments-count\">{{ comment_count }}</span>", "");
    }
}
